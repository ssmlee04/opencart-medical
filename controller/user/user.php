...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_store_permission'] = $this->language->get('entry_store_permission');
		...
		if (isset($this->error['defaultstore'])) {
			$this->data['error_store'] = $this->error['defaultstore'];
		} else {
		...
		if (isset($this->request->post['defaultstore'])) {
			$this->data['defaultstore'] = $this->request->post['defaultstore'];
		} elseif (!empty($user_info)) {
			$this->data['defaultstore'] = $user_info['store_id'];
		} else {
	...
	protected function validateForm() {
		...
		if (empty($this->request->post['defaultstore'])) {
